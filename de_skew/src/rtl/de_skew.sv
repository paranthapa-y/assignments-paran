...
module de_skew (
    ...
    case (state)
      IDLE: begin
        if ((i_stream1 == 4'hA) && (i_stream2 == 4'hA)) begin
          ...
          $display("both");
          //LSB_ind = 2'b01;
        end else if (i_stream1 == 4'hA) begin
          $display("one");
          next_state = FIND;
          //LSB_ind = 2'b01;
        end else if (i_stream2 == 4'hA) begin
          $display("two");
          next_state = FIND;
          //LSB_ind = 2'b10;
        end
  ...
  always_ff @(posedge i_clk) begin
    if (reset) begin
      ...
      fifo1 <= 0;
      fifo2 <= 0;
    end else if (c > 2 && state == FIND) begin
      state <= IDLE;
      c <= 0;
      LSB_ind <= 2'b00;
      fifo1 <= 0;
    ...
    if (state == IDLE) begin
      c <= 0;
      if (i_stream1 == 4'hA && i_stream2 == 4'hA) LSB_ind <= 2'b01;

      else if (i_stream2 == 4'hA) LSB_ind <= 2'b10;

      else if (i_stream1 == 4'hA) LSB_ind <= 2'b01;
