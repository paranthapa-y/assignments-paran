class router_tb extends uvm_component;
    ...
    function void connect_phase(uvm_phase phase);
        ...
        env.agent.monitor.item_collected_port.connect(sb.yapp_imp);

        ch0.monitor.item_collected_port.connect(sb.ch0_imp);
        ch1.monitor.item_collected_port.connect(sb.ch1_imp);
        ch2.monitor.item_collected_port.connect(sb.ch2_imp);
