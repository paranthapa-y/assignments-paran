...
class router_vtest extends base_test;
	...
	function void build_phase(uvm_phase phase);
		super.build_phase(phase);
		`uvm_info("DEBUG","Setting default sequence on virtual sequencer", UVM_NONE)
		...
		uvm_config_wrapper::set(this,"r_tb.vseqr.run_phase","default_sequence",router_disbl_vseq::type_id::get());
